...
func (v *Validator) AddIf(cond bool, field, message string, a ...any) {
	if !cond {
		return
	}
...
func (v *Validator) AddIfUnset(cond bool, field, message string, a ...any) {
	if len((*v)[field]) > 0 {
		return
	}
	v.AddIf(cond, field, message, a...)
}
